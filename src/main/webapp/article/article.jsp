    ...
    $(function(){
        ...
        $("#atcTable").jqGrid({
            ...
            colModel : [
                ...
                {name : 'author',editable:true,index : 'name asc, invdate',width : 50},
                {name : 'crea_date',index : 'note',width : 50,sortable : false}
            ]
        });
...
/*        $("#btn3").click(function(){
            ...
            var rowId=$("#atcTable").jqGrid("getGridParam","selrow");
            alert(rowId+xieee)
            $("#modalFooter").html("<button onclick='delArticle(\""+rowId+"\")' class='btn btn-default'></button >")

        });*/
        $("#btn3").jqGrid(function () {
            var rowId=$("#atcTable").jqGrid("getGridParam","selrow");
            "<button onclick='delArticle(\"\"+rowId+\"\")'></button >"
        })
    });
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="articleForm">
                    ...
                    <div class="input-group">
                        ...
                        <input id="guruNames" name="author" type="text" class="form-control" aria-describedby="basic-addon1"/>
                    </div><br>
